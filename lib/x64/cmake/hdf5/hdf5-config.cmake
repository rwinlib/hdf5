...
set (${HDF5_PACKAGE_NAME}_EXPORT_LIBRARIES hdf5-static;hdf5_tools-static;hdf5_hl-static;hdf5_f90cstub-static;hdf5_fortran-static;hdf5_hl_f90cstub-static;hdf5_hl_fortran-static;hdf5_cpp-static;hdf5_hl_cpp-static)
...
if (NOT TARGET "hdf5")
  if (${HDF5_PACKAGE_NAME}_ENABLE_Z_LIB_SUPPORT AND ${HDF5_PACKAGE_NAME}_PACKAGE_EXTLIBS AND NOT TARGET "zlib")
    include (${PACKAGE_PREFIX_DIR}/lib/cmake//-targets.cmake)
  endif ()
